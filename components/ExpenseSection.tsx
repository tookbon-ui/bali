...
const ExpenseSection: React.FC<Props> = ({ expenses, setExpenses, members, setMembers }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <section className="bg-[#2d5a57] p-6 rounded-[32px] text-white shadow-xl overflow-hidden relative border border-white/10">
      ...
      {isAdding && (
        <div className="bg-white p-6 rounded-[30px] shadow-sm border border-slate-100 space-y-4 animate-in slide-in-from-top-4 duration-300">
          <div className="space-y-4">
            <div>
              <label className="text-[10px] uppercase font-bold text-slate-400 mb-1 block">幣別</label>
            ...
            <div>
              <label className="text-[10px] uppercase font-bold text-slate-400 mb-1 block">內容</label>
              <input 
                placeholder="晚餐、按摩、門票..."
            ...
            <div>
              <label className="text-[10px] uppercase font-bold text-slate-400 mb-2 block">參與成員</label>
          ...
          <div key={exp.id} className="bg-white p-5 rounded-[24px] shadow-sm border border-slate-50 flex items-center justify-between group">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-[10px] font-bold uppercase bg-[#789d9a]/10 text-[#4a7c77] px-2 py-0.5 rounded-md">
